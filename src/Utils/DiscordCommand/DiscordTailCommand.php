...
/**
 * Description of DiscordTailCommand
 *
 * @author lpu8er
 */
class DiscordTailCommand extends DiscordCommand {
    public function help(Discord $discordService) {
        $msg = [];
        $msg[] = '`'.$discordService->getPrefix().'head` '.$discordService->t('throws a coin, success only on tail');
